...
namespace AppSnake8051
{
    public partial class Easy : Form
    {
        ...
        private void Easy_Load(object sender, EventArgs e)
        {
            ...
            {
                serialPort1.Open();
                // Đọc thông tin điểm cao nhất và hiển thị lên labelHighScoreEasy
                string highScoreInfo = ReadHighScore();
                labelHighScoreEasy.Text = string.IsNullOrEmpty(highScoreInfo) ? "Không có điểm cao nhất" : highScoreInfo;
            }
            catch
            {
        ...
        private void Easy_FormClosing(object sender, FormClosingEventArgs e)
        {
        ...
        private void buttonStartEasy_Click(object sender, EventArgs e)
        {
        ...
        private void serialPortReceiver(string input)
        {
            ...
            foreach (char chr in input)
            {
                ...
                if (score != 0 && score != 63)
                {
                    labelScoreEasy.Text = ((byte)chr).ToString() + " ";
        ...
        //private void SaveScore(string playerName, int score, string difficulty)
        //{
        //    try
        //    {
        //        // Đường dẫn đến file lưu điểm
        //        string filePath = "D:/ttktmt/fileKeilC/AppSnake8051/Score.txt";
        //        if (score != 0 && score != 63)
        //        {
        //            // Mở file để ghi thông tin điểm vào
        //            using (StreamWriter writer = new StreamWriter(filePath, true))
        //            {
        //                // Ghi thông tin điểm vào file
        //                writer.WriteLine($"Player: {playerName}, Score: {score}, Difficulty: {difficulty}, Date: {DateTime.Now}");
        //            }
        //        }
        ...
        private string ReadHighScore()
        {
            ...
            {
                // Đường dẫn đến file lưu điểm
                string filePath = "D:/Thuan/ThucTap/Kien_truc_may_tinh/Project/App/AppSnake8051 (1)/highscore_easy.txt";
        ...
        private void SaveHighScore(string playerName, int score, int difficulty)
        {
            try
            {
                ...
                string highScoreFilePath = "D:/Thuan/ThucTap/Kien_truc_may_tinh/Project/App/AppSnake8051 (1)/highscore_easy.txt";
                ...
                if (currentHighScore == null || score > currentHighScore.Score)
                {
                    ...
                    byte newhs = 0x15;
                    newhs1 = newhs;
                    serialPort1.Write(new byte[] { newhs }, 0, 1);
