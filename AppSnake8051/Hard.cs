...
namespace AppSnake8051
{
    public partial class Hard : Form
    {
        ...
        private void Hard_Load(object sender, EventArgs e)
        {
            ...
            {
                serialPort1.Open();
                // Đọc thông tin điểm cao nhất và hiển thị lên labelHighScoreHard
                string highScoreInfo = ReadHighScore();
                labelHighScoreHard.Text = string.IsNullOrEmpty(highScoreInfo) ? "Không có điểm cao nhất" : highScoreInfo;
            }
            catch
            {
        ...
        private void Hard_Close(object sender, FormClosingEventArgs e)
        {
        ...
        private void serialPort1_Hard_DataReceived(object sender, System.IO.Ports.SerialDataReceivedEventArgs e)
        {
        ...
        private void serialPortReceiver(string input)
        {
            ...
            foreach (char chr in input)
            {
                ...
                if (score != 0 && score != 63)
                {
                    labelScoreHard.Text = ((byte)chr).ToString() + " ";
        ...
        private string ReadHighScore()
        {
            try
            {
                ...
                string filePath = "D:/Thuan/ThucTap/Kien_truc_may_tinh/Project/App/AppSnake8051 (1)/highscore_hard.txt";
        ...
        private void SaveHighScore(string playerName, int score, int difficulty)
        {
            try
            {
                ...
                string highScoreFilePath = "D:/Thuan/ThucTap/Kien_truc_may_tinh/Project/App/AppSnake8051 (1)/highscore_hard.txt";
